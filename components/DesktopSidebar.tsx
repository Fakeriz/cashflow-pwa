    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-1">
          ...
          {/* More Settings on Desktop */}
          {onOpenMoreMenu && (
            <button
              id="sidebar-nav-more-settings"
              type="button"
              onClick={onOpenMoreMenu}
              className="w-full flex items-center justify-between px-3.5 py-2.5 rounded-2xl text-xs font-semibold text-zinc-600 dark:text-zinc-400 hover:text-zinc-950 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-zinc-900 transition"
            >
              <div className="flex items-center gap-3">
                <Globe2 className="w-4 h-4" />
                <span>Pengaturan (More)</span>
              </div>
            </button>
          )}
        </div>
